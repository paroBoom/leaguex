    ...
    <div class="sidebar-inner">
        ...
        <ul class="nav">
            ...
            <li class="nav-item <?php if($this->uri->segment(2)=="dashboard"){echo "active";}?>">
                <a href="<?= site_url().'admin/dashboard'; ?>" class="ripple"><i class="mdi mdi-home-outline"></i> <p><?php echo lang('adminsbar_menu_home'); ?></p></a>
            </li>
            <li class="nav-item <?php if($this->uri->segment(2)=="settings"){echo "active";}?>">
                <a data-toggle="collapse" href="#settings" class="ripple"><i class="mdi mdi-settings-outline"></i> <p><?php echo lang('adminsbar_menu_settings'); ?></p></a>
            ...
            <li class="nav-item <?php if($this->uri->segment(2)=="userslist"){echo "active";}?>">
                    <a href="<?= site_url().'admin/userslist'; ?>" class="ripple"><i class="mdi mdi-account-multiple-outline"></i> <p><?php echo lang('adminsbar_menu_users'); ?></p></a>
            </li>                    
        </ul>
    </div>
