<div class="main-wrapper auth-wrapper">
    ...
    <div class="container container-auth">
        ...
        <form action="<?php echo site_url("auth/do_forget"); ?>" method="post" role="form" id="accountRecovery" autocomplete="off">
            ...
            <h5 class="text-center"><?php echo lang('recovery_subtitle'); ?></h5>
            <div class="form-group bmd-form-group">
                <label class="bmd-label-floating"><?php echo lang('form_label_email'); ?></label>                                    
                <input name="email" id="email" type="email" class="form-control">
            </div>
            <div class="form-action">
                <button class="btn btn-raised btn-info btn-block load-btn" type="submit"><?php echo lang('recovery_button_send'); ?></button>
            </div>
